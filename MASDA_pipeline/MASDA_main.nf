...
include { coya_mapping } from './modules/coya_mapping.nf'
...
include { count_targets_coya } from './modules/count_targets_coya.nf'

include { seqtk_fastq_filter } from './modules/seqtk.nf'

params.reads = "/mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/DAPPSeq_pipeline/data/*.fastq.gz"
params.mapping_db = "/mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/DAPPSeq_pipeline/indexes/bowtie2_ResFinder_AMR_index/bowtie2_ResFinder_AMR_index"
params.targets_db = "/mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/DAPPSeq_pipeline/indexes/bowtie2_AMR_amplicon_index/bowtie2_AMR_amplicon_index"
params.db_gtf = "/mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/DAPPSeq_pipeline/references/referencia_resfinder_AMR.gtf"
params.targets_gtf = "/mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/DAPPSeq_pipeline/references/referencia_targets_AMRpanel.gtf"
params.work_title = "AMR"
params.help = false
...
workflow {
    ...
    Options:
        --reads <file/files>        Path to input read file or files (default: data/*.fastq.gz)
        --mapping_db <path>        Path to the Bowtie2 mapping database (default: /mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/scripts/pipeline_nextflow/indexes/bowtie2_AMR_index/bowtie2_AMR_index)
        --targets_db <path>       Path to the targets database (default: /mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/scripts/pipeline_nextflow/indexes/targets_AMRpanel)
        --db_gtf <path>            Path to the GTF file for featureCounts (default: /mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/referencias_paneles/anotacion/referencia_AMR.gtf)
        --targets_gtf <path>      Path to the GTF file for targets (default: /mnt/Disk07/slicandro/ACAJOACO/Secuenciacion_Paneles/referencias_paneles/anotacion/referencia_targets.gtf)
    ...
    coya_aligned = coya_mapping(cleaned, params.mapping_db, params.work_title)
    coya_counts = count_targets_coya(coya_aligned, params.db_gtf, params.work_title)
    ...
    //table = generate_count_table(counts)
}